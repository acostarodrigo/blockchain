...
Various code modernizations have been done. The IoP Core code base has
...
- `IoP-${VERSION}-arm-linux-gnueabihf.tar.gz`: Linux binaries for the most
  common 32-bit ARM architecture.
- `IoP-${VERSION}-aarch64-linux-gnu.tar.gz`: Linux binaries for the most
...
- #7692 `29b2be6` Remove P2P alert system (IoPdrak)
...
- #8275 `042c323` Remove bad chain alert partition check (IoPdrak)
...
- #7619 `18b3f1b` Add missing sudo entry in gitian VM setup (IoPdrak)
- #7616 `639ec58`  [depends] Delete unused patches  (MarcoFalke)
- #7658 `c15eb28` Add curl to Gitian setup instructions (IoPdrak)
...
- #7531 `18cb2d5` Add bip68-sequence.py to extended rpc tests (IoPdrak)
...
- #7773 `7c80e72` Fix comments in tests (IoPdrak)
...
- #7540 `ff46dd4` Rename OP_NOP3 to OP_CHECKSEQUENCEVERIFY (IoPdrak)
