The following is a list of assets used in the IoP source and their proper attribution.
...
* License: MIT
* Site: [https://IoPtalk.org/index.php?topic=15276.0](https://IoPtalk.org/index.php?topic=15276.0)
...
### Info
* Designer: Jonas Schnelli (based on the original IoP logo from Bitboy)
* License: MIT

### Assets Used
	src/qt/res/icons/IoP.icns, src/qt/res/src/IoP.svg,
	src/qt/res/src/IoP.ico, src/qt/res/src/IoP.png,
	src/qt/res/src/IoP_testnet.png, docs/IoP_logo_doxygen.png,
