...
void setupAddressWidget(QValidatedLineEdit *widget, QWidget *parent)
{
    ...
    widget->setFont(IoPAddressFont());
#if QT_VERSION >= 0x040700
    widget->setPlaceholderText(QObject::tr("Enter a IoP address (e.g. 1NS17iag9jJgTHD1VXjvLCEnZuQ3rJDE9L)"));
#endif
...
QString formatIoPURI(const SendCoinsRecipient &info)
{
    ...
    if (info.amount)
    {
        ret += QString("?amount=%1").arg(IoPUnits::format(IoPUnits::IoP, info.amount));
        paramCount++;
    }
