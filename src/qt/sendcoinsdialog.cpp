...
void SendCoinsDialog::on_sendButton_clicked()
{
    ...
    foreach(const SendCoinsRecipient &rcp, recipients)
    {
        ...
        QString amount = "<b>" + IoPUnits::formatWithUnit(model->getOptionsModel()->getDisplayUnit(), rcp.amount);
        amount.append("</b>");
    ...
    if(txFee > 0)
    {
        ...
        questionString.append(IoPUnits::formatWithUnit(model->getOptionsModel()->getDisplayUnit(), txFee));
    ...
    foreach(IoPUnits::Unit u, IoPUnits::availableUnits())
    {
        if(u != model->getOptionsModel()->getDisplayUnit())
            alternativeUnits.append(IoPUnits::formatWithUnit(u, totalAmount));
    }
    questionString.append(tr("Total Amount %1 (= %2)")
        .arg(IoPUnits::formatWithUnit(model->getOptionsModel()->getDisplayUnit(), totalAmount))
...
bool SendCoinsDialog::handlePaymentRequest(const SendCoinsRecipient &rv)
{
    ...
    if (rv.paymentRequest.IsInitialized()) {
        ...
        CIoPAddress address(rv.address.toStdString());
        if (!address.IsValid()) {
