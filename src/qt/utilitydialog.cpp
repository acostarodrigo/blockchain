    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    header = tr("IoP Core") + " " + tr("version") + " " +
        QString::fromStdString(FormatFullVersion()) + "\n\n" +
        tr("Usage:") + "\n" +
        "  IoP-qt [" + tr("command-line options") + "]                     " + "\n";

    coreOptions = QString::fromStdString(HelpMessage(HMM_IoP_QT));
    ...
    ui->helpMessageLabel->setFont(GUIUtil::IoPAddressFont());
...
void ShutdownWindow::showShutdownWindow(IoPGUI *window)
{
    ...
    layout->addWidget(new QLabel(
        tr("IoP Core is shutting down...") + "<br /><br />" +
