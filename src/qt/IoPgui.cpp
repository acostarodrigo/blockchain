...
IoPGUI::IoPGUI(bool fIsTestnet, QWidget *parent) :
    QMainWindow(parent),
    clientModel(0),
    walletFrame(0),
    ...
    spinnerFrame(0)
{
    ...
    QString windowTitle = tr("IoP Core") + " - ";
#ifdef ENABLE_WALLET
    ...
    {
#ifndef Q_OS_MAC
        QApplication::setWindowIcon(QIcon(":icons/IoP"));
        setWindowIcon(QIcon(":icons/IoP"));
#else
        MacDockIconHandler::instance()->setIcon(QIcon(":icons/IoP"));
#endif
    }
    else
    {
...
#ifndef Q_OS_MAC
        QApplication::setWindowIcon(QIcon(":icons/IoP_testnet"));
        setWindowIcon(QIcon(":icons/IoP_testnet"));
#else
        MacDockIconHandler::instance()->setIcon(QIcon(":icons/IoP_testnet"));
#endif
    }
...
void IoPGUI::createActions(bool fIsTestnet)
{
    ...
    if (!fIsTestnet)
        aboutAction = new QAction(QIcon(":/icons/IoP"), tr("&About IoP Core"), this);
    else
        aboutAction = new QAction(QIcon(":/icons/IoP_testnet"), tr("&About IoP Core"), this);
    aboutAction->setStatusTip(tr("Show information about IoP"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for IoP"));
    optionsAction->setMenuRole(QAction::PreferencesRole);
    if (!fIsTestnet)
        toggleHideAction = new QAction(QIcon(":/icons/IoP"), tr("&Show / Hide"), this);
    else
        toggleHideAction = new QAction(QIcon(":/icons/IoP_testnet"), tr("&Show / Hide"), this);
    ...
    showHelpMessageAction->setStatusTip(tr("Show the IoP Core help message to get a list with possible IoP command-line options"));
...
void IoPGUI::createTrayIcon(bool fIsTestnet)
{
#ifndef Q_OS_MAC
    ...
    if (!fIsTestnet)
    {
        trayIcon->setToolTip(tr("IoP client"));
        trayIcon->setIcon(QIcon(":/icons/toolbar"));
    }
    else
    {
        trayIcon->setToolTip(tr("IoP client") + " " + tr("[testnet]"));
...
void IoPGUI::setNumBlocks(int count)
{
...
#ifdef ENABLE_WALLET
void IoPGUI::incomingTransaction(const QString& date, int unit, qint64 amount, const QString& type, const QString& address)
{
