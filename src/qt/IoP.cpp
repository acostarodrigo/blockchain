...
void IoPCore::handleRunawayException(std::exception *e)
{
...
void IoPApplication::createOptionsModel()
{
    optionsModel = new OptionsModel();
}

void IoPApplication::createWindow(bool isaTestNet)
{
    window = new IoPGUI(isaTestNet, 0);
...
void IoPApplication::createSplashScreen(bool isaTestNet)
{
...
int main(int argc, char *argv[])
{
    ...
    {
        QMessageBox::critical(0, QObject::tr("IoP"),
    ...
    if (!SelectParamsFromCommandLine()) {
        QMessageBox::critical(0, QObject::tr("IoP"), QObject::tr("Error: Invalid combination of -regtest and -testnet."));
        return 1;
    }
#ifdef ENABLE_WALLET
    ...
    try
    {
        ...
        WinShutdownMonitor::registerShutdownBlockReason(QObject::tr("IoP Core didn't yet exit safely..."), (HWND)app.getMainWinId());
#endif
        app.exec();
        app.requestShutdown();
        app.exec();
