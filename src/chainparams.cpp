...
static CBlock CreateGenesisBlock(uint32_t nTime, uint32_t nNonce, uint32_t nBits, int32_t nVersion, const CAmount& genesisReward)
{
	 ...
	 * New phrase selected to generate a unique timestamp that will create a unique . Can be anything, just leep it shorter than 90 characters.
	 *
	 */
    const char* pszTimestamp = "La Nacion May 16th 2016 - Sarmiento cerca del descenso";
    /**
     * IoP change by Rodrigo Acosta
     * New coinbase public key generated by IoP. We hold the private key of the Genesis Transaction.
     */
...
public:
    CMainParams() {
        ...
        /**
         * IoP change by Rodrigo Acosta
         * New "magic numbers" generated randomly for the IoP protocol. These bytes will identity the messages as part of our IoP blockchain.
         */
		...
		/**
		 * IoP change by Rodrigo Acosta
		 * New port selected for client connections.
		 */
        nDefaultPort = 4877;
        ...
        /**
         * IoP change by Rodrigo Acosta
         * New Genesis block generation values. Value changes are:
         * 1463452181 is the date when this code was rewritten.
         * 1875087468 is the new nonce that mines the Genesis block.
         */
        genesis = CreateGenesisBlock(1463452181, 1875087468, 0x1d00ffff, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        /**
         * IoP change by Rodrigo Acosta
         * both Genesis block and Merkle roots hashes are new.
         */
		 ...
		 * Seed node list
		 * IoP change by Rodrigo Acosta
		 * New seed node list created. Now we are using the Amazon servers as seed node. This might change in the future.
		 */
		vFixedSeeds.clear();
		vSeeds.clear();
		...
		/**
		 * IoP change by Rodrigo Acosta
		 * New base Prefixes values selected randomly. These are used to generate unique set of base58 IoP address starting with p
		 */
        ...
        /**
         * IoP change by Rodrigo Acosta
         * Removed Bitcoin checkpoints and added only the Genesis block. Later, as the blockchain evolves, we will be adding new checkpoints at new heights
         */
...
public:
    CTestNetParams() {
		 ...
		 * IoP change by Rodrigo Acosta
		 * New Genesis block generation values. Value changes are:
		 * 1463452342 is the date when this code was rewritten.
		 * 3335213172 is the new nonce that mines the Genesis block on testnet.
		 */
        genesis = CreateGenesisBlock(1463452342, 3335213172, 0x1d00ffff, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        /**
         * IoP change by Rodrigo Acosta
         * new genesis block and merkle root specified for TestNet
         * New seed node for testnet also configured on AWS nodes.
         */
		...
		/**
		 * IoP change by Rodrigo Acosta
		 * New base58 prefixes to generate addresses on testnet.
		 */
        ...
        /**
         * IoP change by Rodrigo Acosta
         * removed previous checkpoints. We will be adding new ones as Testnet blockchain evolves.
         */
        checkpointData = (CCheckpointData) {
            boost::assign::map_list_of
...
public:
    CRegTestParams() {
         ...
         * new magic bytes for Regtest network.
         * New port selected.
         */
        ...
        /**
         * IoP changes by Rodrigo Acosta
         * new genesis block generation with our own values and very low difficulty.
         */
        ...
        /**
         * IoP change by Rodrigo Acosta
         * We use the same base58 prefixes than TestNet to generate the same addresses.
         */
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,130);
		base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,49);
		base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,76);
