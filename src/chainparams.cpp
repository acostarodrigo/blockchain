...
unsigned int pnSeed[] =
{
    ...
    0xc15ebb6a, 0x2c08c452, 0xc7fd0652, 0x7604f8ce, 0xffb34872, 0xa4c2efd5, 0xe9614018, 0xab49e557,
...
public:
    CMainParams() {
        ...
        vAlertPubKey = ParseHex("04db0f57cd33acb1bbef6088ace7cfd417d943936f9594eaa9d25e62e5af4a43ffb31830cbcc9c499b935e2961e3e77b5644cfbb316096d0d931b34427f8fab682");
        nDefaultPort = 4877;
        nRPCPort = 8337;
        ...
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("04ce49f9cdc8d23176c818fd7e27e7b614d128a47acfdad0e4542300e7efbd8879f1337af3188c0dcb0747fdf26d0cb3b0fca0f4e5d7aec53c43f4a933f570ae86") << OP_CHECKSIG;
        genesis.vtx.push_back(txNew);
        genesis.hashPrevBlock = 0;
        genesis.hashMerkleRoot = genesis.BuildMerkleTree();
        genesis.nVersion = 1;
        genesis.nTime    = 1463452181;
		genesis.nBits    = 0x1d00ffff;
		genesis.nNonce   = 1875087468;

        hashGenesisBlock = genesis.GetHash();
        assert(hashGenesisBlock == uint256("0x00000000bf5f2ee556cb9be8be64e0776af14933438dbb1af72c41bfb6c82db3"));
		assert(genesis.hashMerkleRoot == uint256("0x951bc46d2da95047fb4a2c0f9b7d6e45591c3ffb49ab2fdffb8e96ef2b8f2be1"));
		...
		base58Prefixes[SECRET_KEY] =     list_of(49);
		base58Prefixes[EXT_PUBLIC_KEY] = list_of(0x27)(0x80)(0x91)(0x5F);
		base58Prefixes[EXT_SECRET_KEY] = list_of(0xAE)(0x34)(0x16)(0xF6);
...
public:
    CTestNetParams() {
        ...
        vAlertPubKey = ParseHex("04ce49f9cdc8d23176c818fd7e27e7b614d128a47acfdad0e4542300e7efbd8879f1337af3188c0dcb0747fdf26d0cb3b0fca0f4e5d7aec53c43f4a933f570ae86");
        nDefaultPort = 7475;
        nRPCPort = 18337;
        strDataDir = "testnet3";

        // Modify the testnet genesis block so the timestamp is valid for a later start.
        genesis.nTime = 1463452342;
		genesis.nNonce = 3335213172;
		hashGenesisBlock = genesis.GetHash();
		assert(hashGenesisBlock == uint256("0x000000006f2bb863230cda4f4fbee520314077e599a90b9c6072ea2018d7f3a3"));
		...
		base58Prefixes[SECRET_KEY]     = list_of(76);
		base58Prefixes[EXT_PUBLIC_KEY] = list_of(0xBB)(0x8F)(0x48)(0x52);
		base58Prefixes[EXT_SECRET_KEY] = list_of(0x2B)(0x7F)(0xA4)(0x2A);
    }
...
public:
    CRegTestParams() {
        ...
        genesis.nTime = 1463452384;
		genesis.nBits = 0x207fffff;
		genesis.nNonce = 2528424328;
        hashGenesisBlock = genesis.GetHash();
        nDefaultPort = 14877;
        strDataDir = "regtest";
        assert(hashGenesisBlock == uint256("0x13ac5baa4b3656eec3ae4ab24b44ae602b9d1e549d9f1f238c1bfce54571b8b5"));
