...
Then, to tunnel a SSL connection on 24872 to a RPC server bound on localhost on port 7474 do:

    stunnel -d 24872 -r 127.0.0.1:7474 -p stunnel.pem -P ''
...
caching. A sample config for apache2 could look like:
    ...
    <Location /bitcoinrpc>
        ProxyPass http://127.0.0.1:4872/
        ProxyPassReverse http://127.0.0.1:4872/
