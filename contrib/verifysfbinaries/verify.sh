...
SIGNATUREFILE="http://downloads.sourceforge.net/project/IoP/IoP/IoP-0.9.0rc1/SHA256SUMS.asc"

SIGNATUREFILENAME="SHA256SUMS.asc"
RCSUBDIR="test/"
BASEDIR="http://downloads.sourceforge.net/project/IoP/IoP/"
VERSIONPREFIX="IoP-"
RCVERSIONSTRING="rc"
...
if [ $? -ne 0 ]; then
   ...
   echo "[IoP-]<version>-[rc[0-9]] (example: IoP-0.7.1-rc1)"
   echo "wget output:"
